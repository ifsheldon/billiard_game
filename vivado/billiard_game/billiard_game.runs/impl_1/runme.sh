...
HD_PWD='/home/uzahid/workspace/billiard_game/vivado/billiard_game/billiard_game.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log game_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source game_wrapper.tcl -notrace
