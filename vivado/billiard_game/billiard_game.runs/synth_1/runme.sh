...
HD_PWD='/home/uzahid/workspace/billiard_game/vivado/billiard_game/billiard_game.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log game_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source game_wrapper.tcl
